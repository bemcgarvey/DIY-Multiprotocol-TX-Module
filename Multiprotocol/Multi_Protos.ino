...
#ifndef MULTI_EU
	const char STR_SUBTYPE_DSM[] =        "\x04""2 1F""2 2F""X 1F""X 2F""Auto""R 1F""X 3F""X 4F";
#else
...
// Protocol number, Protocol String, Sub_protocol strings, Number of sub_protocols, Option type, Failsafe, ChMap, RF switch, Init, Callback
		...
		{PROTO_DSM,        STR_DSM,       STR_SUBTYPE_DSM,       8, OPTION_MAXTHR,  0, 1, SW_CYRF,   DSM_init,        DSM_callback        },
	#endif
